  ...
  if (loadingProducts || loadingUsers){
    ...
    return (
        <div className="row justify-content-evenly mt-4 ">
            <div className="card-cafeArte text-cafeArte bg-cafeArte mb-3 col-lg-3 col-sm-4 col-xs-6 border-5 shadow-card" >
            ...
            <div className="card-cafeArte  text-cafeArte bg-cafeArte mb-3 col-lg-3 col-sm-4 col-xs-6 shadow-card" >
